    ...
    public partial class startIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "/images/1.jpg", 20000m, "Elechek", false, "" },
                    { 2, 1, "/images/2.jpg", 10000m, "Kurzhun", false, "" },
                    { 3, 2, "/images/3.jpg", 25000m, "Chapan", false, "" },
                    { 4, 2, "/images/4.jpg", 15000m, "Chyptama", false, "" },
                    { 5, 2, "/images/5.jpg", 20000m, "Beldemchi", false, "" },
                    { 6, 2, "/images/6.jpg", 13000m, "Takyia", false, "" },
                    { 7, 2, "/images/7.jpg", 23000m, "Chapan-Kurtka", false, "" }
                });
